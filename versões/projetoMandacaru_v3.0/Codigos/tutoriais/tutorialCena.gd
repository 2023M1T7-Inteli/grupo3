...
func _on_botaoPassar_pressed():
	...
	#condição que ativa quado o contador excede 5
	if contador == 4:
		#torna a variável "terminouTutorial" verdadeira
		terminouTutorial = true
