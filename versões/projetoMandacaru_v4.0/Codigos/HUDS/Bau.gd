...
func _ready():
	...
	if Global.notif != null:
		if Global.notif == "pipoca":
			$ItemConquistado.text = "Pipoca"
		elif Global.notif == "baloes":
			$ItemConquistado.text = "Baloes"
		elif Global.notif == "instrumentos":
			$ItemConquistado.text = "Instrumentos"
		elif Global.notif == "roupa":
			$ItemConquistado.text = "Roupa"
		elif Global.notif == "fitas":
			$ItemConquistado.text = "Fitas"
		$Notif.visible = false
